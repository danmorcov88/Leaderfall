...
<!-- results:start -->
Last full run: 2026-09-22T08:32:17+00:00, 16/16 passed, on Linux-6.17.0-1022-azure-x86_64-with-glibc2.39 (4 CPUs).

| Scenario | Profile / sync | Result | Detection | RTO write | Commit stall | Lost acked | Unknown | Split brain | Fenced | Rejoin |
|---|---|---|---|---|---|---|---|---|---|---|
| `double-fault` | default / off | pass | 24.6 s | 27.6 s | 27.6 s | 0 | 0 | no | - | 1.8 s |
| `etcd-one-member-loss` | default / off | pass | - | 0.0 s | 0.0 s | 0 | 0 | no | - | - |
| `etcd-quorum-loss` | default / off | pass | - | 34.3 s | 25.2 s | 0 | 0 | no | 9.1 s | - |
| `fast-profile-primary-sigkill` | fast / off | pass | 16.1 s | 18.2 s | 18.2 s | 0 | 0 | no | - | 2.1 s |
| `haproxy-restart` | default / off | pass | - | 5.7 s | 0.7 s | 0 | 0 | no | - | - |
| `lagging-replica-failover` | default / off | pass | - | 74.9 s | 61.8 s | 0 | 0 | no | - | 62.7 s |
| `lagging-replica-stale-optime` | default / off | pass | 25.3 s | 28.1 s | 26.9 s | 4 | 0 | no | - | 0.0 s |
| `planned-switchover` | default / off | pass | 7.1 s | 9.8 s | 4.1 s | 0 | 0 | no | - | - |
| `primary-clean-stop` | default / off | pass | 1.6 s | 5.3 s | 5.2 s | 0 | 0 | no | - | 1.5 s |
| `primary-frozen` | default / off | pass | 22.6 s | 25.0 s | 25.0 s | 0 | 0 | yes | 35.6 s | 4.0 s |
| `primary-partition` | default / off | pass | 31.6 s | 35.0 s | 34.9 s | 0 | 0 | no | 17.1 s | 10.9 s |
| `primary-sigkill` | default / off | pass | 23.6 s | 27.2 s | 27.1 s | 0 | 0 | no | - | 2.2 s |
| `replica-loss` | default / off | pass | - | 0.0 s | 0.0 s | 0 | 0 | no | - | 1.3 s |
| `sync-mode-primary-sigkill` | default / on | pass | 26.7 s | 28.3 s | 28.3 s | 0 | 0 | no | - | 2.2 s |
| `sync-replica-loss-strict` | default / strict | pass | - | 0.0 s | 6.0 s | 0 | 0 | no | - | 1.2 s |
| `sync-replica-loss` | default / on | pass | - | 0.0 s | 6.0 s | 0 | 0 | no | - | 1.2 s |
<!-- results:end -->
