...
<!-- results:start -->
Last full run: 2026-09-21T08:53:01+00:00, 16/16 passed, on Linux-6.17.0-1022-azure-x86_64-with-glibc2.39 (4 CPUs).

| Scenario | Profile / sync | Result | Detection | RTO write | Commit stall | Lost acked | Unknown | Split brain | Fenced | Rejoin |
|---|---|---|---|---|---|---|---|---|---|---|
| `double-fault` | default / off | pass | 21.6 s | 23.7 s | 23.7 s | 0 | 0 | no | - | 3.2 s |
| `etcd-one-member-loss` | default / off | pass | - | 0.0 s | 0.0 s | 0 | 0 | no | - | - |
| `etcd-quorum-loss` | default / off | pass | - | 44.9 s | 25.3 s | 0 | 0 | no | 19.6 s | - |
| `fast-profile-primary-sigkill` | fast / off | pass | 16.1 s | 18.2 s | 18.2 s | 0 | 0 | no | - | 3.2 s |
| `haproxy-restart` | default / off | pass | - | 5.5 s | 0.5 s | 0 | 0 | no | - | - |
| `lagging-replica-failover` | default / off | pass | - | 74.6 s | 62.4 s | 0 | 0 | no | - | 63.1 s |
| `lagging-replica-stale-optime` | default / off | pass | 26.6 s | 30.0 s | 29.9 s | 5 | 0 | no | - | 0.2 s |
| `planned-switchover` | default / off | pass | 7.1 s | 10.2 s | 4.5 s | 0 | 0 | no | - | - |
| `primary-clean-stop` | default / off | pass | 1.6 s | 5.4 s | 5.2 s | 0 | 0 | no | - | 1.5 s |
| `primary-frozen` | default / off | pass | 23.1 s | 26.2 s | 26.2 s | 0 | 0 | yes | 36.6 s | 6.3 s |
| `primary-partition` | default / off | pass | 28.6 s | 32.1 s | 32.0 s | 0 | 0 | no | 14.1 s | 14.3 s |
| `primary-sigkill` | default / off | pass | 30.1 s | 33.2 s | 33.2 s | 0 | 0 | no | - | 3.7 s |
| `replica-loss` | default / off | pass | - | 0.0 s | 0.0 s | 0 | 0 | no | - | 2.2 s |
| `sync-mode-primary-sigkill` | default / on | pass | 26.2 s | 30.0 s | 29.9 s | 0 | 0 | no | - | 3.5 s |
