...
<!-- results:start -->
Last full run: 2026-09-20T08:35:46+00:00, 16/16 passed, on Linux-6.17.0-1022-azure-x86_64-with-glibc2.39 (4 CPUs).

| Scenario | Profile / sync | Result | Detection | RTO write | Commit stall | Lost acked | Unknown | Split brain | Fenced | Rejoin |
|---|---|---|---|---|---|---|---|---|---|---|
| `double-fault` | default / off | pass | 25.1 s | 27.7 s | 27.6 s | 0 | 0 | no | - | 3.4 s |
| `etcd-one-member-loss` | default / off | pass | - | 0.0 s | 0.2 s | 0 | 0 | no | - | - |
| `etcd-quorum-loss` | default / off | pass | - | 42.7 s | 25.3 s | 0 | 0 | no | 17.6 s | - |
| `fast-profile-primary-sigkill` | fast / off | pass | 16.3 s | 20.1 s | 20.1 s | 0 | 0 | no | - | 3.6 s |
| `haproxy-restart` | default / off | pass | - | 5.4 s | 0.4 s | 0 | 0 | no | - | - |
| `lagging-replica-failover` | default / off | pass | - | 78.9 s | 66.6 s | 0 | 0 | no | - | 64.1 s |
| `lagging-replica-stale-optime` | default / off | pass | 24.6 s | 26.6 s | 26.4 s | 4 | 0 | no | - | 0.0 s |
| `planned-switchover` | default / off | pass | 7.1 s | 10.6 s | 4.9 s | 0 | 0 | no | - | - |
| `primary-clean-stop` | default / off | pass | 1.6 s | 5.3 s | 5.2 s | 0 | 0 | no | - | 7.6 s |
| `primary-frozen` | default / off | pass | 27.1 s | 30.1 s | 30.1 s | 0 | 1 | yes | 40.6 s | 7.2 s |
| `primary-partition` | default / off | pass | 28.1 s | 31.3 s | 31.3 s | 0 | 0 | no | 13.1 s | 16.1 s |
| `primary-sigkill` | default / off | pass | 28.0 s | 30.8 s | 30.8 s | 0 | 0 | no | - | 4.4 s |
| `replica-loss` | default / off | pass | - | 0.0 s | 0.3 s | 0 | 0 | no | - | 2.2 s |
| `sync-mode-primary-sigkill` | default / on | pass | 26.0 s | 28.9 s | 28.9 s | 0 | 0 | no | - | 4.7 s |
| `sync-replica-loss-strict` | default / strict | pass | - | 0.0 s | 5.8 s | 0 | 0 | no | - | 2.0 s |
