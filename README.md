...
<!-- results:start -->
Last full run: 2026-09-19T08:06:29+00:00, 16/16 passed, on Linux-6.17.0-1022-azure-x86_64-with-glibc2.39 (4 CPUs).

| Scenario | Profile / sync | Result | Detection | RTO write | Commit stall | Lost acked | Unknown | Split brain | Fenced | Rejoin |
|---|---|---|---|---|---|---|---|---|---|---|
| `double-fault` | default / off | pass | 25.1 s | 27.4 s | 27.4 s | 0 | 0 | no | - | 3.4 s |
| `etcd-one-member-loss` | default / off | pass | - | 0.0 s | 0.4 s | 0 | 0 | no | - | - |
| `etcd-quorum-loss` | default / off | pass | - | 44.5 s | 25.6 s | 0 | 0 | no | 19.1 s | - |
| `fast-profile-primary-sigkill` | fast / off | pass | 16.1 s | 19.9 s | 19.9 s | 0 | 0 | no | - | 3.5 s |
| `haproxy-restart` | default / off | pass | - | 5.4 s | 0.4 s | 0 | 0 | no | - | - |
| `lagging-replica-failover` | default / off | pass | - | 74.7 s | 62.4 s | 0 | 0 | no | - | 63.0 s |
| `lagging-replica-stale-optime` | default / off | pass | 25.6 s | 28.0 s | 27.8 s | 5 | 0 | no | - | 0.4 s |
| `planned-switchover` | default / off | pass | 7.1 s | 10.7 s | 5.0 s | 0 | 0 | no | - | - |
| `primary-clean-stop` | default / off | pass | 1.6 s | 5.2 s | 5.2 s | 0 | 0 | no | - | 7.6 s |
| `primary-frozen` | default / off | pass | 26.6 s | 30.0 s | 30.0 s | 0 | 0 | yes | 40.6 s | 7.0 s |
| `primary-partition` | default / off | pass | 27.6 s | 31.4 s | 31.4 s | 0 | 0 | no | 13.6 s | 16.4 s |
| `primary-sigkill` | default / off | pass | 27.6 s | 31.0 s | 31.0 s | 0 | 0 | no | - | 4.2 s |
| `replica-loss` | default / off | pass | - | 0.0 s | 0.1 s | 0 | 0 | no | - | 2.3 s |
| `sync-mode-primary-sigkill` | default / on | pass | 26.0 s | 29.2 s | 29.2 s | 0 | 0 | no | - | 4.4 s |
| `sync-replica-loss-strict` | default / strict | pass | - | 0.0 s | 6.1 s | 0 | 0 | no | - | 2.0 s |
| `sync-replica-loss` | default / on | pass | - | 0.0 s | 5.7 s | 0 | 0 | no | - | 2.0 s |
<!-- results:end -->
