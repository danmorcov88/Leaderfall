...
<!-- results:start -->
Last full run: 2026-09-24T08:26:01+00:00, 16/16 passed, on Linux-6.17.0-1022-azure-x86_64-with-glibc2.39 (4 CPUs).

| Scenario | Profile / sync | Result | Detection | RTO write | Commit stall | Lost acked | Unknown | Split brain | Fenced | Rejoin |
|---|---|---|---|---|---|---|---|---|---|---|
| `double-fault` | default / off | pass | 21.6 s | 23.7 s | 23.7 s | 0 | 0 | no | - | 3.1 s |
| `etcd-one-member-loss` | default / off | pass | - | 0.0 s | 0.0 s | 0 | 0 | no | - | - |
| `etcd-quorum-loss` | default / off | pass | - | 37.1 s | 24.6 s | 0 | 0 | no | 12.6 s | - |
| `fast-profile-primary-sigkill` | fast / off | pass | 16.6 s | 18.3 s | 18.3 s | 0 | 0 | no | - | 3.0 s |
| `haproxy-restart` | default / off | pass | - | 5.5 s | 0.4 s | 0 | 0 | no | - | - |
| `lagging-replica-failover` | default / off | pass | - | 74.6 s | 62.4 s | 0 | 0 | no | - | 62.9 s |
| `lagging-replica-stale-optime` | default / off | pass | 25.1 s | 28.4 s | 28.2 s | 5 | 0 | no | - | 0.3 s |
| `planned-switchover` | default / off | pass | 7.1 s | 9.4 s | 3.8 s | 0 | 0 | no | - | - |
| `primary-clean-stop` | default / off | pass | 1.6 s | 5.5 s | 5.2 s | 0 | 0 | no | - | 1.3 s |
| `primary-frozen` | default / off | pass | 23.0 s | 26.1 s | 26.1 s | 0 | 0 | yes | 36.5 s | 4.2 s |
| `primary-partition` | default / off | pass | 30.6 s | 32.4 s | 32.3 s | 0 | 0 | no | 15.6 s | 14.9 s |
| `primary-sigkill` | default / off | pass | 31.1 s | 33.3 s | 33.3 s | 0 | 0 | no | - | 3.4 s |
| `replica-loss` | default / off | pass | - | 0.0 s | 0.0 s | 0 | 0 | no | - | 2.2 s |
| `sync-mode-primary-sigkill` | default / on | pass | 26.2 s | 27.9 s | 27.9 s | 0 | 0 | no | - | 3.5 s |
| `sync-replica-loss-strict` | default / strict | pass | - | 0.0 s | 6.0 s | 0 | 0 | no | - | 2.2 s |
