...
<!-- results:start -->
Last full run: 2026-09-23T08:36:33+00:00, 15/16 passed, on Linux-6.17.0-1022-azure-x86_64-with-glibc2.39 (4 CPUs).

| Scenario | Profile / sync | Result | Detection | RTO write | Commit stall | Lost acked | Unknown | Split brain | Fenced | Rejoin |
|---|---|---|---|---|---|---|---|---|---|---|
| `double-fault` | default / off | pass | 24.6 s | 26.7 s | 26.7 s | 0 | 0 | no | - | 2.1 s |
| `etcd-one-member-loss` | default / off | pass | - | 0.0 s | 0.0 s | 0 | 0 | no | - | - |
| `etcd-quorum-loss` | default / off | pass | - | 45.7 s | 26.6 s | 0 | 0 | no | 19.6 s | - |
| `fast-profile-primary-sigkill` | fast / off | pass | 16.6 s | 19.0 s | 19.0 s | 0 | 0 | no | - | 2.9 s |
| `haproxy-restart` | default / off | pass | - | 6.1 s | 1.1 s | 0 | 0 | no | - | - |
| `lagging-replica-failover` | default / off | pass | - | 78.6 s | 65.5 s | 0 | 1 | no | - | 63.1 s |
...
| `primary-frozen` | default / off | pass | 22.6 s | 26.2 s | 26.2 s | 0 | 0 | yes | 36.6 s | 4.3 s |
| `primary-partition` | default / off | pass | 30.1 s | 32.1 s | 32.0 s | 0 | 0 | no | 16.6 s | 14.3 s |
| `primary-sigkill` | default / off | pass | 31.6 s | 34.2 s | 34.2 s | 0 | 0 | no | - | 2.6 s |
| `replica-loss` | default / off | pass | - | 0.0 s | 0.0 s | 0 | 0 | no | - | 2.2 s |
| `sync-mode-primary-sigkill` | default / on | pass | 26.2 s | 29.5 s | 29.5 s | 0 | 0 | no | - | 3.9 s |
| `sync-replica-loss-strict` | default / strict | pass | - | 0.0 s | 5.9 s | 0 | 0 | no | - | 2.2 s |
| `sync-replica-loss` | default / on | pass | - | 0.0 s | 5.8 s | 0 | 0 | no | - | 2.2 s |
<!-- results:end -->
